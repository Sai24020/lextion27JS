...
function renderMovieToUI() {
    ...
    document.getElementById("header-title").innerText = currentMovie.name;
    document.getElementById("movie-rtRating").innerText = currentMovie.age + "År";
    document.getElementById("movie-description").innerText = currentMovie.eye_color + currentMovie.hair_color;
